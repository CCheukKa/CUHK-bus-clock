...
export const busStationTimings: Record<string, number[]> = {
    ...
    [`${Station.CHUNG_CHI_TEACHING_BUILDING}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [199],
    ...
    [`${Station.UNIVERSITY_SPORTS_CENTRE}>>${Station.SIR_RUN_RUN_SHAW_HALL}`]: [132, 139, 110, 153, 147, 127, 145, 153, 123, 140, 149, 132, 109, 145],

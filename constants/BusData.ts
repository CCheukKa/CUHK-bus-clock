...
export const busStationTimings: Record<string, number[]> = {
    ...
    [`${Station.SIR_RUN_RUN_SHAW_HALL}>>${Station.UNIVERSITY_ADMIN_BUILDING}`]: [90, 157],
    ...
    [`${Station.UNIVERSITY_SPORTS_CENTRE}>>${Station.SIR_RUN_RUN_SHAW_HALL}`]: [132, 139, 110, 153, 147, 127, 145, 153, 123, 140, 149, 132, 109],
    [`${Station.UNIVERSITY_STATION}>>${Station.POSTGRADUATE_HALL_1}`]: [124],
    [`${Station.UNIVERSITY_STATION}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [135, 111, 91, 127, 112, 126, 146, 107, 123, 131],

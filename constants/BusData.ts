...
export const busStationTimings: Record<string, number[]> = {
    ...
    [`${Station.NEW_ASIA_COLLEGE}>>${Station.UNITED_COLLEGE_DOWNWARD}`]: [53],
    ...
    [`${Station.SHHO_COLLEGE}>>${Station.UNIVERSITY_STATION_TERMINUS}`]: [95],
    ...
    [`${Station.UNITED_COLLEGE_DOWNWARD}>>${Station.UNIVERSITY_ADMIN_BUILDING}`]: [81],
    ...
    [`${Station.UNITED_COLLEGE_UPWARD}>>${Station.NEW_ASIA_COLLEGE}`]: [],
    [`${Station.UNIVERSITY_ADMIN_BUILDING}>>${Station.SCIENCE_CENTRE}`]: [],
    [`${Station.UNIVERSITY_ADMIN_BUILDING}>>${Station.SHHO_COLLEGE}`]: [98, 103],
    [`${Station.UNIVERSITY_SPORTS_CENTRE}>>${Station.FUNG_KING_HEY_BUILDING}`]: [],
    [`${Station.UNIVERSITY_SPORTS_CENTRE}>>${Station.SCIENCE_CENTRE}`]: [116],
    [`${Station.UNIVERSITY_SPORTS_CENTRE}>>${Station.SIR_RUN_RUN_SHAW_HALL}`]: [132, 139, 110, 153, 147, 127, 145, 153, 123, 140],
    [`${Station.UNIVERSITY_STATION}>>${Station.POSTGRADUATE_HALL_1}`]: [124],
    [`${Station.UNIVERSITY_STATION}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [135, 111, 91, 127, 112, 126, 146, 107],
    [`${Station.UNIVERSITY_STATION_PIAZZA}>>${Station.CHUNG_CHI_TEACHING_BUILDING_TERMINUS}`]: [],
    [`${Station.UNIVERSITY_STATION_PIAZZA}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [157, 171],

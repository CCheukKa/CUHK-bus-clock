...
export const busStationTimings: Record<string, number[]> = {
    ...
    [`${Station.CHAN_CHUN_HA_HOSTEL}>>${Station.SHAW_COLLEGE_DOWNWARD}`]: [118, 97],
    ...
    [`${Station.CWC_COLLEGE_UPWARD}>>${Station.AREA_39_UPWARD}`]: [],
    [`${Station.FUNG_KING_HEY_BUILDING}>>${Station.UNITED_COLLEGE_UPWARD}`]: [91],
    ...
    [`${Station.NEW_ASIA_COLLEGE}>>${Station.WU_YEE_SUN_COLLEGE_UPWARD}`]: [],
    [`${Station.NEW_ASIA_COLLEGE}>>${Station.UNITED_COLLEGE_DOWNWARD}`]: [53, 74],
    [`${Station.POSTGRADUATE_HALL_1}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [107],
    ...
    [`${Station.SHAW_COLLEGE_DOWNWARD}>>${Station.WU_YEE_SUN_COLLEGE_DOWNWARD}`]: [123, 79],
    ...
    [`${Station.SHAW_COLLEGE_UPWARD}>>${Station.CWC_COLLEGE_DOWNWARD_TERMINUS}`]: [126, 109],
    [`${Station.SHHO_COLLEGE}>>${Station.POSTGRADUATE_HALL_1}`]: [],
    ...
    [`${Station.SHHO_COLLEGE}>>${Station.UNIVERSITY_STATION_TERMINUS}`]: [95, 106],
    [`${Station.SIR_RUN_RUN_SHAW_HALL}>>${Station.FUNG_KING_HEY_BUILDING}`]: [63],
    ...
    [`${Station.UNTIED_COLLEGE_STAFF_RESIDENCE}>>${Station.CHAN_CHUN_HA_HOSTEL}`]: [59, 55],
    [`${Station.UNITED_COLLEGE_UPWARD}>>${Station.NEW_ASIA_COLLEGE}`]: [76],
    [`${Station.UNIVERSITY_ADMIN_BUILDING}>>${Station.SCIENCE_CENTRE}`]: [],
    [`${Station.UNIVERSITY_ADMIN_BUILDING}>>${Station.SHHO_COLLEGE}`]: [98, 103, 83],
    ...
    [`${Station.UNIVERSITY_SPORTS_CENTRE}>>${Station.SIR_RUN_RUN_SHAW_HALL}`]: [132, 139, 110, 153, 147, 127, 145, 153, 123, 140, 149, 132],
    [`${Station.UNIVERSITY_STATION}>>${Station.POSTGRADUATE_HALL_1}`]: [124],
    [`${Station.UNIVERSITY_STATION}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [135, 111, 91, 127, 112, 126, 146, 107, 123],
    [`${Station.UNIVERSITY_STATION_PIAZZA}>>${Station.CHUNG_CHI_TEACHING_BUILDING_TERMINUS}`]: [],
    [`${Station.UNIVERSITY_STATION_PIAZZA}>>${Station.UNIVERSITY_SPORTS_CENTRE}`]: [157, 171, 176],
    [`${Station.WU_YEE_SUN_COLLEGE_DOWNWARD}>>${Station.NEW_ASIA_COLLEGE}`]: [84],
    [`${Station.WU_YEE_SUN_COLLEGE_DOWNWARD}>>${Station.UNIVERSITY_ADMIN_BUILDING}`]: [93],
